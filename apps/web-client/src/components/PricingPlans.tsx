...
import { getPricingDetail, planDefinitions, planOrder, PlanType, Region, resolveRegion } from '@/lib/pricing/catalog';
            ...
            <div key={plan.planType} className={cardClass}>
              ...
              <div className="mb-8">
                ...
                <div className="mt-6 flex items-end gap-2">
                  ...
                  <div className="text-sm text-zinc-500 pb-1">{plan.period}</div>
                </div>
              </div>
