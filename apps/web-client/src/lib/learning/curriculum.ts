...
export const courseCurriculum: CourseCurriculumWeek[] = [
  ...
  {
    week: 1,
    module: 'Forex Ground Zero',
    level: 'Beginner',
    description: 'Start from absolute zero: understand the history, purpose, mechanics, and practical meaning of forex before strategy, indicators, or advanced analysis.',
    days: [
      {
        day: 'Monday', dayIndex: 1, dayTheme: 'What Forex Is and Why It Exists',
        lessons: [
          { number: 1, title: 'A Brief History of Currency Exchange: From Gold to Floating FX', type: 'lesson',
            summary: 'A beginner-friendly timeline of how foreign exchange evolved from physical conversion and fixed pegs to today\'s global, always-on currency market.',
            slug: lessonSlug(1, 'Monday', 1, 'A Brief History of Currency Exchange: From Gold to Floating FX') },
          { number: 2, title: 'What the Forex Market Actually Is (Layman Explanation)', type: 'lesson',
            summary: 'A plain-English explanation of forex as the price of one money versus another, and why exchange rates change every second.',
            slug: lessonSlug(1, 'Monday', 2, 'What the Forex Market Actually Is (Layman Explanation)') },
          { number: 3, title: 'Who Uses Forex Every Day: Banks, Businesses, Travelers, Traders', type: 'lesson',
            summary: 'How normal real-world activity creates forex demand: imports, exports, tourism, remittances, investment flows, and central bank operations.',
            slug: lessonSlug(1, 'Monday', 3, 'Who Uses Forex Every Day: Banks, Businesses, Travelers, Traders') },
        ],
      },
      {
        day: 'Tuesday', dayIndex: 2, dayTheme: 'How Forex Pricing and Execution Work',
        lessons: [
          { number: 1, title: 'Currency Pairs in Plain Language: Base, Quote, and Value', type: 'lesson',
            summary: 'How to interpret pair pricing in simple terms using everyday examples, including what it means when a pair rises or falls.',
            slug: lessonSlug(1, 'Tuesday', 1, 'Currency Pairs in Plain Language: Base, Quote, and Value') },
          { number: 2, title: 'Bid, Ask, and Spread: The Real Cost of Getting In and Out', type: 'lesson',
            summary: 'What you pay when you open a trade, why spread changes by session and news, and how this affects short-term strategies.',
            slug: lessonSlug(1, 'Tuesday', 2, 'Bid, Ask, and Spread: The Real Cost of Getting In and Out') },
          { number: 3, title: 'Pips, Lot Size, and Leverage Without Confusion', type: 'lesson',
            summary: 'A practical guide to pip value, position size, and leverage impact so beginners understand exposure before placing real trades.',
            slug: lessonSlug(1, 'Tuesday', 3, 'Pips, Lot Size, and Leverage Without Confusion') },
        ],
      },
      {
        day: 'Wednesday', dayIndex: 3, dayTheme: 'Sessions, Liquidity, and Why Price Moves Faster at Certain Times',
        lessons: [
          { number: 1, title: 'The 24-Hour Forex Clock: Asia, London, and New York Sessions', type: 'lesson',
            summary: 'When each major session is active, which pairs are most responsive, and how session structure should shape trade timing decisions.',
            slug: lessonSlug(1, 'Wednesday', 1, 'The 24-Hour Forex Clock: Asia, London, and New York Sessions') },
          { number: 2, title: 'London-New York Overlap: When Most Big Moves Happen', type: 'lesson',
            summary: 'Why overlap hours produce deeper liquidity and stronger directional movement, with practical guidance for beginners.',
            slug: lessonSlug(1, 'Wednesday', 2, 'London-New York Overlap: When Most Big Moves Happen') },
          { number: 3, title: 'Low-Liquidity Traps: Why Beginners Get Caught in Choppy Hours', type: 'lesson',
            summary: 'How thin markets create fake moves and poor entries, and how to avoid low-quality setups by respecting session behavior.',
            slug: lessonSlug(1, 'Wednesday', 3, 'Low-Liquidity Traps: Why Beginners Get Caught in Choppy Hours') },
        ],
      },
      {
        day: 'Thursday', dayIndex: 4, dayTheme: 'From Chart to Meaning: Reading Price Like a Human',
        lessons: [
          { number: 1, title: 'Candlesticks for Complete Beginners: What Each Candle Tells You', type: 'lesson',
            summary: 'A simple method to read candle body, wick, and close location to understand buying/selling pressure without indicator overload.',
            slug: lessonSlug(1, 'Thursday', 1, 'Candlesticks for Complete Beginners: What Each Candle Tells You') },
          { number: 2, title: 'Trend, Range, and Breakout in Plain Terms', type: 'lesson',
            summary: 'How to describe market state clearly and avoid random entries by matching your decision to visible structure.',
            slug: lessonSlug(1, 'Thursday', 2, 'Trend, Range, and Breakout in Plain Terms') },
          { number: 3, title: 'How News Becomes Price Movement (Practical Example Walkthrough)', type: 'lesson',
            summary: 'Step-by-step explanation of how an economic release changes expectations and then flows through to immediate price action.',
            slug: lessonSlug(1, 'Thursday', 3, 'How News Becomes Price Movement (Practical Example Walkthrough)') },
        ],
      },
      {
        day: 'Friday', dayIndex: 5, dayTheme: 'Beginner Delusions, Risk Reality, and Survival Rules',
        lessons: [
          { number: 1, title: 'The Biggest Forex Beginner Delusions and Why They Fail', type: 'lesson',
            summary: 'Debunking common myths: quick money, overtrading, indicator addiction, and high-leverage gambling disguised as strategy.',
            slug: lessonSlug(1, 'Friday', 1, 'The Biggest Forex Beginner Delusions and Why They Fail') },
          { number: 2, title: 'Risk-First Thinking: How Professionals Protect Capital First', type: 'lesson',
            summary: 'Why survival is the first target in forex, with a practical risk framework based on position size, stop logic, and consistent rules.',
            slug: lessonSlug(1, 'Friday', 2, 'Risk-First Thinking: How Professionals Protect Capital First') },
          { number: 3, title: 'Your First Practical Forex Framework: Observe, Plan, Execute, Review', type: 'lesson',
            summary: 'A beginner-ready operating loop that turns random trading into process-driven decision making from day one.',
            slug: lessonSlug(1, 'Friday', 3, 'Your First Practical Forex Framework: Observe, Plan, Execute, Review') },
        ],
      },
      {
        day: 'Saturday', dayIndex: 6, dayTheme: 'Assignment: Build Your Forex Ground-Zero Toolkit',
        lessons: [
          { number: 1, title: 'Create Your Forex Glossary: 50 Terms in Plain English', type: 'assignment',
            summary: 'Build your own beginner dictionary of core forex terms so charts, news, and broker screens become understandable and actionable.',
            slug: lessonSlug(1, 'Saturday', 1, 'Create Your Forex Glossary: 50 Terms in Plain English') },
          { number: 2, title: 'One-Day Pair Observation: Session-by-Session Behavior Notes', type: 'assignment',
            summary: 'Observe one major pair across sessions and document spread, volatility, and movement style to internalize how market timing changes outcomes.',
            slug: lessonSlug(1, 'Saturday', 2, 'One-Day Pair Observation: Session-by-Session Behavior Notes') },
          { number: 3, title: 'Write Your One-Page Forex Operating Guide for Week 2', type: 'assignment',
            summary: 'Summarize how forex works, when you will trade, what you will avoid, and your risk guardrails before proceeding to technical chapters.',
            slug: lessonSlug(1, 'Saturday', 3, 'Write Your One-Page Forex Operating Guide for Week 2') },
        ],
      },
    ],
  },
